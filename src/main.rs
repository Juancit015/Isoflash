        ...
        std::thread::spawn(move || {
            ...
            match result {
                ...
                Ok(o)  => {
                    ...
                    if o.status.success() || stdout.to_lowercase().contains("ventoy") || stdout.to_lowercase().contains("done") {
                        ...
                        send(1.0,"Cancelado: no se proporciono contrasena",LogLevel::Warn,true);
                    } else {
